...
*/          if (prune_flag) {
        ...
        while(count_times < num_times)//vec_last_level_vertices.size()
        {
        ...
        //get the most valuable longest path
            ...
            if(( max_vertices_new >= vec_longest_path.size()*3/4 )&& vec_longest_path.size()>3)
            {
    ...
    std::cout<<"BFS ended . Begin to creat index structure......";
    //create index structure
